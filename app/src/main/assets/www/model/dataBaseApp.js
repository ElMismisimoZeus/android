...
var sql_paciente =   "CREATE TABLE IF NOT EXISTS PACIENTE ("+
    ...
    "TELEFONO TEXT," +
    "OCUPACION TEXT," +
    "SEXOS_ID_SEXOS INTEGER,"+
    "SERVICIO_MEDICO INTEGER,"+
    "CALLE TEXT,"+
    "NUMERO INTEGER,"+
    "COLONIA INTEGER,"+
    "DELEGACION INTEGER,"+
    "CTLG_ESTADOS_ID_ESTADOS INTEGER," +
    "CP INTEGER," +
    "MOTIVO_ATENCION INTEGER" +
    ")";
...
var sql_evaluacion_primaria = "CREATE TABLE IF NOT EXISTS EVALUACION_PRIMARIA("+
    ...
    "CTLG_PRIORIDAD_ID INTEGER,"+
    "CTLG_NIVEL_CONCIENCIA_ID INTEGER,"+
    "CTLG_VIA_AEREA_ID INTEGER,"+
    "CTLG_VENTILACION_ID INTEGER,"+
    "CTLG_CALIDAD_VENTILACION_ID INTEGER,"+
    "CTLG_PULSOS_ID INTEGER,"+
    "CTLG_PULSOS_CALIDAD_ID INTEGER,"+
    "CTLG_RITMO_ID INTEGER,"+
    "CTLG_COLORACION_ID INTEGER,"+
    "CTLG_TEMPERATURA_ID INTEGER,"+
    "CTLG_CONDICION_ID INTEGER,"+
    "POSICION INTEGER"+
    ")";
...
var sql_evaluacion_secundaria = "CREATE TABLE IF NOT EXISTS EVALUACION_SECUNDARIA("+
    ...
    "CTLG_SIGNOS_NEUROLOGICOS_ID INTEGER," +
...
var sql_paro_cardiorespiratorio =  "CREATE TABLE IF NOT EXISTS PARO_CARDIORESPIRATORIO ("+
    ...
    "TIPO_FRAP TEXT,"+
    "OCURRIO INTEGER," +
    "CTLG_MOTIVOS_NOREANIMACION_ID_CTLG_MOTIVOS_NOREANIMACION INTEGER, "+
    "CTLG_TIPO_REANIMACION_ID_CTLG_TIPO_REANIMACION INTEGER, " +
    "CTLG_TIPO_ETIOLOGIA_ID_CTLG_TIPO_ETIOLOGIA INTEGER,"+
    "RETORNO_CIRCULACION_ESPONTANEA INTEGER," +
    "TIEMPO_REANIMACION INTEGER,"+
    "HORA_DETIENE_RCP TEXT," +
    "PARO_ARRIBO INTEGER," +
    "PARO_RCP INTEGER,"  +
    "PARO_DESFIB INTEGER," +
    "PARO_SVA INTEGER," +
...
var sql_clinico =  "CREATE TABLE IF NOT EXISTS CLINICO ("+
    ...
    "CTLG_ORIGEN_PROBABLE_ID INTEGER,"+
    "OBSERVACIONES TEXT"+
    ")";
...
var sql_vial =  "CREATE TABLE IF NOT EXISTS VIAL ("+
    "ID_FRAP INTEGER,"+
    "TIPO_FRAP TEXT,"+
    "CTLG_TIPO_ACCIDENTE_VIAL_ID INTEGER,"+
    "CTLG_TIPO_LESIONADO_ID INTEGER," +
    "CTLG_ACTOR_VIAL_ID INTEGER,"+
    "CTLG_ATROPELLADO_POR_ID INTEGER,"+
    "EYECTADO INTEGER,"+
    "DECESOS INTEGER,"+
    "PRENSADO INTEGER,"+
    "CASCO INTEGER,"+
    "CTLG_IMPACTO_ID INTEGER,"+
    "CTLG_VOLANTE_ID INTEGER,"+
    "CTLG_PARABRISAS_ID INTEGER,"+
    "CTLG_BOLSA_AIRE_ID INTEGER,"+
    "CTLG_CINTURON_SEGURIDAD_ID INTEGER,"+
    "OBSERVACIONES TEXT"+
    ")";
...
var sql_trauma =  "CREATE TABLE IF NOT EXISTS TRAUMA ("+
    ...
    "CTLG_AGENTE_CAUSAL_GENERAL_ID INTEGER,"+
    "CTLG_AGENTE_CAUSAL_ESPECIFICO_ID INTEGER,"+
    "OBSERVACIONES TEXT"+
    ")";
...
var sql_tratamiento =  "CREATE TABLE IF NOT EXISTS TRATAMIENTO ("+
    ...
    "TIPO_FRAP TEXT,"+
    "ASPIRACION INTEGER,"+
    "CTLG_DISPOSITIVO_APERTURA_ID_CTLG_DISPOSITIVO_APERTURA INTEGER,"+
    "CTLG_MANEJO_VIA_AEREA_ID_CTLG_MANEJO_VIA_AEREA INTEGER," +
    "DISPOSITIVO INTEGER," +
    "FRECUENCIA INTEGER,"+
    "VOLUMEN INTEGER," +
    "MODALIDAD_VENTILATORIA TEXT,"+
    "LITROS_MINUTO INTEGER,"+
    "CTLG_OXIGENOTERAPIA_ID INTEGER," +
    "CTLG_HEMITORAX_ID_CTLG_HEMITORAX INTEGER" +
    "CALIBRE INTEGER,"+
    "HORA_COLOCACION TEXT,"+
    "CTLG_CONTROL_HEMORAGIAS_ID INTEGER,"+
    "CTLG_VIA_ACCESO_ID_CTLG_VIA_ACCESO INTEGER,"+
