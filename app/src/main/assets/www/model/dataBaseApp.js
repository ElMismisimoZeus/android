...
var sql_tratamiento =   "CREATE TABLE IF NOT EXISTS TRATAMIENTO ("+
    ...
    "ID_MANEJO_VIA_AEREA INTEGER,"+

    "ID_INTUBACION INTEGER,"+

    "ID_CTLG_DISPOSITIVO_APERTURA INTEGER," +

    "ID_CTLG_MANEJO_VIA_AEREA INTEGER," +

    "ID_CTLG_DISPOSITIVO INTEGER," +
    ...
    "ID_CTLG_ZONA_COLOCACION INTEGER," +

    "ID_CTLG_SOLUCION INTEGER,"+
